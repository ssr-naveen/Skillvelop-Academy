...
export default async function Page({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
  ...
  return <LmsShell profile={profile} activeRole="student" activePath="/dashboard/student/curriculum" eyebrow="My learning library" title="Choose a course" subtitle="Open a course to explore its chapters, lessons, assignments, quizzes and assessments in one clear learning path.">
    ...
    <div className="course-library-summary"><div><span>YOUR ACTIVE COURSES</span><h2>Continue your learning journey</h2><p>Each course opens into a structured chapter pathway with clear progress and tutor-controlled access.</p></div><strong>{courses.length}<small>courses</small></strong></div>
