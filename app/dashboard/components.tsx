...
export function Notice({ params }: { params?: { created?: string; updated?: string; submitted?: string; sent?: string; deleted?: string; error?: string; score?: string; max?: string } }) {
  ...
  if (params.updated === "class") return <div className="notice success" role="status"><strong>Done</strong><span>Scheduled class updated for the tutor and learner.</span></div>;
  if (params.deleted === "class") return <div className="notice success" role="status"><strong>Done</strong><span>Scheduled class deleted from the tutor and learner calendars.</span></div>;
