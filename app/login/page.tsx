...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string; returnTo?: string }> }) {
  ...
  return <main className={styles.page}>
    ...
    <footer className={styles.footer}><span>© 2026 Skillvelop Academy</span><span className={styles.footerTrust}><ShieldCheck size={12}/> Protected access</span><a href="/contact">Contact &amp; support</a></footer>
  </main>;
}
